...
ENTRYPOINT ["conda", "run", "-n", "mlflow-env", "python", "./flask_app.py"]

# To build, type docker build -f ./dockerfile -t dangawne/review_demo .
# docker run -p 6000:6000 dangawne/review_demo
